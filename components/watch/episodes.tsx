...
import { Episode } from "@/types/animeData";
...
const Episodes = ({ episodes, query, moreEpisodes, screen }: EpisodesProps) => {
  return (
    <>
      <aside
        className={cn(
      ...
      >
        ...
        >
          ...
          {episodes?.map((episode, index) => {
            const isCurrent = query === episode.id;
            const isMoreEpisodes = moreEpisodes > 24;
            const isEpisodeFiller = false;
